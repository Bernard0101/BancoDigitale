...
class ContoStruttura{
    ...
    private List <ContoStruttura> contati = new ArrayList<ContoStruttura>();
    Scanner scan = new Scanner(System.in);

    //construtore 
    public ContoStruttura(int codiciFiscale, String nome, int etta, String segna, double denaro, List <ContoStruttura> contati){
    ...
    public boolean verificaSegna(String inputSegna){
        return inputSegna.equals(this.segna);
    }

    public void adizionareContato(ContoStruttura contato){
        contati.add(contato);
        System.out.println(this.getNome()+" adizionato ai tui contati");
    }
